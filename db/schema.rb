...
ActiveRecord::Schema[7.1].define(version: 2024_07_22_182516) do
  ...
  create_table "blog_pictures", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["blog_content_id"], name: "index_blog_pictures_on_blog_content_id"
  end
  ...
  add_foreign_key "blog_pictures", "blog_contents"
end
